...
- [How To Create And Deploy A VSCode Extension](https://www.youtube.com/watch?v=q5V4T3o3CXE&list=LL&index=8&pp=gAQBiAQB)
- [Build And Publish A VS Code Extension In 20 Minutes](https://www.youtube.com/watch?v=Nf4BNuRvWO8&list=LL&index=2)
- [Building Your First Extension in VS Code](https://www.youtube.com/watch?v=i5wK7_E9SWo&list=LL&index=4)
- [how to test an extension and how to make an extension run in the web](https://www.youtube.com/watch?v=4WblV-wbih8)
- [how to create a custom theme in Visual Studio Code](https://www.youtube.com/watch?v=FeApSxfazVg)
- [creating a VS Code extension from scratch](https://www.youtube.com/watch?v=9pAxk7oVoA8)
- [Creating VS Code extensions for Python-based tools | Part 1](https://www.youtube.com/watch?v=EHpFewLrEZo)
- [Creating VS Code extensions for Python-based tools | Part 2](https://www.youtube.com/watch?v=9p_ceWPbl0Q)
